# kisaanconnect-local
A web-based platform that connects local farmers with bulk buyers for planned procurement of agricultural products by enabling direct discovery and coordination.
...
- Buyer: Search for the product and analyse description and contact farmer
    1. Search
    2. View
    3. Contact
    4. Visit/receive
...
# Difference from traditional Mandis
- Mandis: Post harvest market,physical
...
- logistics tracking
- Mobile application
- Integration with local FPOs,and SHGs.
